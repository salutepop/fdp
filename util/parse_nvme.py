...
def parse_setup_cmd(line):
    ...
    if match:
        ...
        key = f'{qid}_{cmd_id}'
        io_dict[key] = IO(qid, cmd_id, cmd_type, timestamp,
...
def main(args):
    ...
    with open(input_file, 'r') as file:
        with open(output_file, 'w') as output_file:
            output_file.write(
                'cmd_id,cmd_type,issue_time,comp_time,qid,qdepth,qdepth_total,latency,slba,len,dsmgmt\n')
