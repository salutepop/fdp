                ...
                with open(log_path, 'r') as f:
                    for line in f:
                        ...
                        if "Bytes" in line:
                            ...
                            match = re.search(r"Written Data Units (\d+) Physical (\d+)", line)
                            if match:
                                # 숫자 값 추출
                                ...
                                if (written_data_unit, physical) not in seen:
                                    ...
                                    relative_path = os.path.relpath(log_path, base_dir)
                                    result.append((relative_path, written_data_unit, physical))
...
print(tabulate(parsed_data, headers=table_headers, tablefmt="grid"))
